...
const filterRowTreeFromTreeData = params => {
  ...
  const filterTreeNode = (node, isParentMatchingFilters, areAncestorsExpanded) => {
    ...
    if (shouldSkipFilters) {
      ...
      isMatchingFilters = (0, _internals.passFilterLogic)([filterResults.passingFilterItems], [filterResults.passingQuickFilterValues], params.filterModel, params.filterValueGetter, params.apiRef, filterCache);
    }
