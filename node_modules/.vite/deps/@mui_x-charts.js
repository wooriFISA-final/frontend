...
import {
  ...
  markElementClasses
} from "./chunk-WYTDSX3O.js";
import "./chunk-7OJF5L7N.js";
...
import {
  ...
  yellowPaletteDark,
  yellowPaletteLight
} from "./chunk-N24564OH.js";
import "./chunk-F5IOLA3N.js";
import {
  arc_default,
  number_default
} from "./chunk-QJFVMTDL.js";
import "./chunk-6TILZ4F6.js";
import {
  warnOnce
} from "./chunk-TTGKUZR6.js";
import "./chunk-KG2QBO33.js";
import "./chunk-GIOEQXBJ.js";
import "./chunk-22V3A5HG.js";
import "./chunk-OTQDONCS.js";
import "./chunk-LIGWN237.js";
import {
  useSlotProps_default
} from "./chunk-7YJWJ6U4.js";
import "./chunk-HOYVJ4OR.js";
import "./chunk-AO26XZZS.js";
import "./chunk-DRKBKFSX.js";
import "./chunk-EYD7JM2D.js";
import {
...
import "./chunk-YXVAWICV.js";
import "./chunk-ITGWAFDM.js";
import "./chunk-ZCSSBJ3Q.js";
import "./chunk-P3LZCDSG.js";
import "./chunk-JCR6BWBJ.js";
import {
  useThemeProps
} from "./chunk-7L6E3QDB.js";
import "./chunk-F5X6INBZ.js";
import "./chunk-AVYP2IMP.js";
import "./chunk-C7APTRKP.js";
import "./chunk-Z25YPBV6.js";
import "./chunk-OWNWW6QQ.js";
import "./chunk-SUSNWJV4.js";
import "./chunk-4TWQJHIF.js";
import "./chunk-5ZO3TYJB.js";
import "./chunk-GOZHMSIK.js";
import "./chunk-RVGCLC75.js";
import "./chunk-SDRFNETW.js";
import "./chunk-6LYN3DNF.js";
import "./chunk-O3P2VEWN.js";
import "./chunk-UBDN5FJ6.js";
import "./chunk-XZ4HLCZR.js";
import "./chunk-QVY2QQV3.js";
import "./chunk-CNDRH4ZQ.js";
import "./chunk-HDCEBUTE.js";
import {
  useTheme
...
var SCATTER_CHART_PLUGINS = [useChartZAxis, useChartBrush, useChartInteraction, useChartCartesianAxis, useChartHighlight, useChartClosestPoint, useChartKeyboardNavigation];
...
var GaugeContext = React12.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function useGaugeState() {
  return React12.useContext(GaugeContext);
}
...
var GaugeContainer = React13.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
  ...
  return (0, import_jsx_runtime10.jsx)(ChartProvider, {
    pluginParams: {
      width: inWidth,
      height: inHeight,
    ...
    children: (0, import_jsx_runtime10.jsx)(GaugeProvider, {
      ...
      cx,
      cy,
      children: (0, import_jsx_runtime10.jsx)(ChartsSurface, _extends({
        title,
        desc,
        role: "meter",
        ...
        ref,
        children: (0, import_jsx_runtime10.jsx)(GStyled, {
          "aria-hidden": "true",
          children
        })
      }))
...
true ? GaugeContainer.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types8.default.oneOfType([import_prop_types8.default.number, import_prop_types8.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types8.default.oneOfType([import_prop_types8.default.number, import_prop_types8.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types8.default.oneOfType([import_prop_types8.default.number, import_prop_types8.default.string]),
  desc: import_prop_types8.default.string,
  /**
   * The end angle (deg).
   * @default 360
   */
  endAngle: import_prop_types8.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types8.default.oneOfType([import_prop_types8.default.number, import_prop_types8.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   *
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types8.default.oneOfType([import_prop_types8.default.number, import_prop_types8.default.string]),
  /**
   * If `true`, animations are skipped.
   * If unset or `false`, the animations respects the user's `prefers-reduced-motion` setting.
   */
   ...
   * @default 0
   */
  startAngle: import_prop_types8.default.number,
   ...
   * @default 100
   */
  valueMax: import_prop_types8.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types8.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
...
function GaugeValueArc(_ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(AnimatedGaugeValueArc, _extends({}, other, {
...
function AnimatedGaugeValueArc(_ref2) {
  ...
  return (0, import_jsx_runtime11.jsx)(StyledPath, _extends({}, animatedProps, {
...
true ? AnimatedGaugeValueArc.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  cornerRadius: import_prop_types9.default.number.isRequired,
  cx: import_prop_types9.default.number.isRequired,
  cy: import_prop_types9.default.number.isRequired,
  endAngle: import_prop_types9.default.number.isRequired,
  innerRadius: import_prop_types9.default.number.isRequired,
...
true ? GaugeValueText.propTypes = {
  ...
  text: import_prop_types10.default.oneOfType([import_prop_types10.default.func, import_prop_types10.default.string])
} : void 0;

// node_modules/@mui/x-charts/esm/Gauge/Gauge.js
var import_jsx_runtime14 = __toESM(require_jsx_runtime(), 1);
var _excluded8 = ["text", "children", "classes", "className", "skipAnimation"];
...
var Gauge = React17.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className,
  ...
  return (0, import_jsx_runtime14.jsxs)(GaugeContainer, _extends({}, other, {
    ...
    ref,
    children: [(0, import_jsx_runtime14.jsx)(GaugeReferenceArc, {}), (0, import_jsx_runtime14.jsx)(GaugeValueArc, {
      skipAnimation
...
true ? Gauge.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types11.default.oneOfType([import_prop_types11.default.number, import_prop_types11.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types11.default.oneOfType([import_prop_types11.default.number, import_prop_types11.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types11.default.oneOfType([import_prop_types11.default.number, import_prop_types11.default.string]),
  desc: import_prop_types11.default.string,
  /**
   * The end angle (deg).
   * @default 360
   */
  endAngle: import_prop_types11.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types11.default.oneOfType([import_prop_types11.default.number, import_prop_types11.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   *
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types11.default.oneOfType([import_prop_types11.default.number, import_prop_types11.default.string]),
  /**
   * If `true`, animations are skipped.
   * If unset or `false`, the animations respects the user's `prefers-reduced-motion` setting.
   */
   ...
   * @default 0
   */
  startAngle: import_prop_types11.default.number,
   ...
   * @default 100
   */
  valueMax: import_prop_types11.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types11.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
...
var _excluded9 = ["apiRef", "series", "radar", "width", "height", "margin", "colors", "sx", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "hideLegend", "divisions", "shape", "stripeColor", "highlight", "showToolbar", "onAxisClick", "onAreaClick", "onMarkClick"];
...
function SharpRadarGrid(props) {
  ...
  return (0, import_jsx_runtime15.jsxs)(React18.Fragment, {
    children: [corners.map(({
      x,
      y
    }, i) => (0, import_jsx_runtime15.jsx)("path", {
    ...
    }, i)), divisionRatio.map((ratio) => (0, import_jsx_runtime15.jsx)("path", {
      d: `M ${corners.map(({
        x,
        y
...
function CircularRadarGrid(props) {
  ...
  return (0, import_jsx_runtime16.jsxs)(React19.Fragment, {
    children: [corners.map(({
      ...
      fill: "none",
      className: classes?.radial
    }, i)), divisionRadius.map((r) => (0, import_jsx_runtime16.jsx)("circle", {
      cx: center.x,
      cy: center.y,
      r,
      stroke: strokeColor,
...
function RadarGrid(props) {
  ...
  return shape === "sharp" ? (0, import_jsx_runtime19.jsxs)(React22.Fragment, {
    children: [stripeColor && (0, import_jsx_runtime19.jsx)(SharpRadarStripes, {
      divisions,
      corners,
      center,
      radius,
      stripeColor,
      classes
    }), (0, import_jsx_runtime19.jsx)(SharpRadarGrid, {
      divisions,
      corners,
      center,
      radius,
  ...
  }) : (0, import_jsx_runtime19.jsxs)(React22.Fragment, {
    children: [stripeColor && (0, import_jsx_runtime19.jsx)(CircularRadarStripes, {
      divisions,
      corners,
      center,
      radius,
      stripeColor,
      classes
    }), (0, import_jsx_runtime19.jsx)(CircularRadarGrid, {
      divisions,
      corners,
      center,
      radius,
...
true ? RadarGrid.propTypes = {
   ...
   * @default 5
   */
  divisions: import_prop_types12.default.number,
  /**
   * The grid shape.
   * @default 'sharp'
   */
  shape: import_prop_types12.default.oneOf(["circular", "sharp"]),
  /**
   ...
   */
  stripeColor: import_prop_types12.default.func
} : void 0;
...
var _excluded10 = ["series", "children", "width", "height", "colors", "skipAnimation", "margin", "radar", "highlight", "plugins"];
...
function RadarDataProvider(props) {
  ...
  const rotationAxes = React23.useMemo(() => [{
  ...
  const radiusAxis = React23.useMemo(() => radar.metrics.map((m) => {
    const {
      name,
      min = 0,
      max = radar.max
  ...
  const defaultizedSeries = React23.useMemo(() => series.map((s) => _extends({
    type: "radar",
  ...
  const defaultizedMargin = React23.useMemo(() => defaultizeMargin(margin, DEFAULT_RADAR_MARGIN), [margin]);
  return (0, import_jsx_runtime20.jsx)(ChartDataProvider, _extends({}, other, {
...
function useRadarRotationIndex() {
  ...
  const rotationIndexGetter = React24.useCallback(function rotationIndexGetter2(event) {
...
var _excluded11 = ["seriesId", "onItemClick"];
...
function RadarSeriesArea(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(React25.Fragment, {
    children: seriesCoordinates?.map(({
      ...
      return (0, import_jsx_runtime21.jsx)("path", _extends({}, getPathProps({
        seriesId: id,
        points,
        color,
        fillArea,
...
true ? RadarSeriesArea.propTypes = {
   ...
   */
  seriesId: import_prop_types13.default.string
} : void 0;
  ...
  return (0, import_jsx_runtime22.jsx)(React26.Fragment, {
    children: seriesCoordinates?.map(({
      ...
      return (0, import_jsx_runtime22.jsx)("g", {
        children: points.map((point, index) => (0, import_jsx_runtime22.jsx)("circle", _extends({}, getCircleProps({
          seriesId: id,
          point,
          color,
          fillArea,
  ...
  return (0, import_jsx_runtime23.jsx)("g", {
    ...
    children: seriesCoordinates?.map(({
      ...
      return (0, import_jsx_runtime23.jsxs)("g", {
        children: [(0, import_jsx_runtime23.jsx)("path", _extends({}, getPathProps({
          seriesId,
          points,
          color,
          fillArea,
        ...
        }, interactionProps[seriesIndex]), seriesId), !hideMark && points.map((point, index) => (0, import_jsx_runtime23.jsx)("circle", _extends({}, getCircleProps({
          seriesId,
          point,
          color,
          fillArea,
...
function RadarAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime24.jsxs)("g", {
    ...
    children: [(0, import_jsx_runtime24.jsx)("path", {
      ...
      return (0, import_jsx_runtime24.jsx)("circle", _extends({
...
function RadarMetricLabels() {
  ...
  const theme = useTheme();
  return (0, import_jsx_runtime25.jsx)(React29.Fragment, {
    children: corners.map(({
      x,
      y,
      angle,
      label
    }, i) => (0, import_jsx_runtime25.jsx)(ChartsText, {
      x,
      y,
      fontSize: 14,
      fill: (theme.vars || theme).palette.text.primary,
...
var RadarChart = React30.forwardRef(function RadarChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiRadarChart"
  });
  ...
  return (0, import_jsx_runtime26.jsx)(RadarDataProvider, _extends({}, radarDataProviderProps, {
    children: (0, import_jsx_runtime26.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar2 ? (0, import_jsx_runtime26.jsx)(Toolbar2, _extends({}, props.slotProps?.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime26.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime26.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        ref,
...
true ? RadarChart.propTypes = {
   ...
   * @default 5
   */
  divisions: import_prop_types17.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default 'axis'
   */
  highlight: import_prop_types17.default.oneOf(["axis", "none", "series"]),
  /**
   * The highlighted item.
   * Used when the highlight is controlled.
   */
   ...
   * @param {RadarItemIdentifier} radarItemIdentifier The radar item identifier.
   */
  onAreaClick: import_prop_types17.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   ...
   * @param {RadarItemIdentifier} radarItemIdentifier The radar item identifier.
   */
  onMarkClick: import_prop_types17.default.func,
  /**
   * The configuration of the radar scales.
   */
  radar: import_prop_types17.default.shape({
    labelFormatter: import_prop_types17.default.func,
    labelGap: import_prop_types17.default.number,
    max: import_prop_types17.default.number,
    metrics: import_prop_types17.default.oneOfType([import_prop_types17.default.arrayOf(import_prop_types17.default.string), import_prop_types17.default.arrayOf(import_prop_types17.default.shape({
      max: import_prop_types17.default.number,
      min: import_prop_types17.default.number,
      name: import_prop_types17.default.string.isRequired
    }))]).isRequired,
    startAngle: import_prop_types17.default.number
  }).isRequired,
  /**
   ...
   * @default 'sharp'
   */
  shape: import_prop_types17.default.oneOf(["circular", "sharp"]),
  /**
   * If true, shows the default chart toolbar.
   * @default false
   */
   ...
   * @default (index) => index % 2 === 1 ? (theme.vars || theme).palette.text.secondary : 'none'
   */
  stripeColor: import_prop_types17.default.func,
...
true ? RadarAxis.propTypes = {
   ...
   */
  dominantBaseline: import_prop_types18.default.oneOfType([import_prop_types18.default.oneOf(["alphabetic", "auto", "central", "hanging", "ideographic", "inherit", "mathematical", "middle", "no-change", "reset-size", "text-after-edge", "text-before-edge", "use-script"]), import_prop_types18.default.func]),
  /**
   ...
   * @default 'horizontal'
   */
  labelOrientation: import_prop_types18.default.oneOf(["horizontal", "rotated"]),
  /**
   * The metric to get.
   * If `undefined`, the hook returns `null`
   */
  metric: import_prop_types18.default.string,
  /**
   * The labels text anchor or a function returning the text anchor for a given axis angle (in degree).
   */
  textAnchor: import_prop_types18.default.oneOfType([import_prop_types18.default.oneOf(["end", "inherit", "middle", "start"]), import_prop_types18.default.func])
} : void 0;
...
var ChartContainer = React32.forwardRef(function ChartContainer2(props, ref) {
  const {
    chartDataProviderProps,
    children,
    chartsSurfaceProps
  } = useChartContainerProps(props, ref);
  return (0, import_jsx_runtime28.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime28.jsx)(ChartsSurface, _extends({}, chartsSurfaceProps, {
      children
    }))
  }));
});
...
true ? ChartContainer.propTypes = {
   ...
   * Configuration for the brush interaction.
   */
  brushConfig: import_prop_types19.default.shape({
    enabled: import_prop_types19.default.bool,
    preventHighlight: import_prop_types19.default.bool,
    preventTooltip: import_prop_types19.default.bool
  }),
  ...
  enableKeyboardNavigation: import_prop_types19.default.bool,
  /**
   * Options to enable features planned for the next major.
   */
  experimentalFeatures: import_prop_types19.default.shape({
    preferStrictDomainInLineCharts: import_prop_types19.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   */
  highlightedAxis: import_prop_types19.default.arrayOf(import_prop_types19.default.shape({
    axisId: import_prop_types19.default.oneOfType([import_prop_types19.default.number, import_prop_types19.default.string]).isRequired,
   ...
   */
  onHighlightedAxisChange: import_prop_types19.default.func,
  /**
   ...
   * An array of [[AxisConfig]] objects.
   */
  radiusAxis: import_prop_types19.default.arrayOf(import_prop_types19.default.shape({
    ...
    maxRadius: import_prop_types19.default.number,
    min: import_prop_types19.default.number,
    minRadius: import_prop_types19.default.number,
   ...
   * An array of [[AxisConfig]] objects.
   */
  rotationAxis: import_prop_types19.default.arrayOf(import_prop_types19.default.oneOfType([import_prop_types19.default.shape({
    ...
    groups: import_prop_types19.default.arrayOf(import_prop_types19.default.shape({
    ...
    ignoreTooltip: import_prop_types19.default.bool,
    label: import_prop_types19.default.string,
    labelGap: import_prop_types19.default.number,
    labelStyle: import_prop_types19.default.object,
    offset: import_prop_types19.default.number,
    position: import_prop_types19.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types19.default.bool,
    ...
    constant: import_prop_types19.default.number,
    data: import_prop_types19.default.array,
    dataKey: import_prop_types19.default.string,
    disableLine: import_prop_types19.default.bool,
    disableTicks: import_prop_types19.default.bool,
    ...
    position: import_prop_types19.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types19.default.bool,
    scaleType: import_prop_types19.default.oneOf(["symlog"]),
    slotProps: import_prop_types19.default.object,
    slots: import_prop_types19.default.object,
    startAngle: import_prop_types19.default.number,
    sx: import_prop_types19.default.oneOfType([import_prop_types19.default.arrayOf(import_prop_types19.default.oneOfType([import_prop_types19.default.func, import_prop_types19.default.object, import_prop_types19.default.bool])), import_prop_types19.default.func, import_prop_types19.default.object]),
    ...
    labelGap: import_prop_types19.default.number,
    labelStyle: import_prop_types19.default.object,
    max: import_prop_types19.default.oneOfType([import_prop_types19.default.number, import_prop_types19.default.shape({
      valueOf: import_prop_types19.default.func.isRequired
    })]),
    min: import_prop_types19.default.oneOfType([import_prop_types19.default.number, import_prop_types19.default.shape({
      valueOf: import_prop_types19.default.func.isRequired
    })]),
    offset: import_prop_types19.default.number,
    position: import_prop_types19.default.oneOf(["bottom", "none", "top"]),
   ...
   * If `undefined`, the radius is assumed to be infinite.
   */
  voronoiMaxRadius: import_prop_types19.default.oneOfType([import_prop_types19.default.oneOf(["item"]), import_prop_types19.default.number]),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
...
function BrushRect(props) {
  return (0, import_jsx_runtime29.jsx)("rect", _extends({
