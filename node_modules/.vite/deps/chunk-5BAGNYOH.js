...
var ToggleButtonGroup = React2.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  const handleChange = React2.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  const handleExclusiveChange = React2.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
...
//# sourceMappingURL=chunk-5BAGNYOH.js.map
